...
- VARIABLES CLAVE: DATABASE_URL (postgresql://barber:barber@localhost:5432/barberstudio), Supabase keys
- Pasos: copiar .env.example a .env.local, instalar dependencias, migrar, seed, levantar server
- URLs importantes de Supabase y Cloudinary ya configuradas en .env.local
