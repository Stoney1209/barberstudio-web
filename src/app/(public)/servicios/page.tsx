    ...
    <div className="min-h-screen bg-gradient-mesh bg-noise pt-20 pb-24 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-gold/60 text-sm uppercase tracking-widest mb-3">Catálogo</p>
          ...
          <p className="text-muted/70 max-w-xl mx-auto">
            ...
            Cada servicio diseñado para resaltar tu estilo personal.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <p className="text-muted/70 mb-6 line-clamp-3">
                    {service.description || 'Servicio premium de barbería con productos de primera calidad'}
                  </p>
        ...
        {filteredServices.length === 0 && !loading && (
          <div className="text-center py-16">
            <p className="text-muted/60 text-lg">No hay servicios en esta categoría</p>
          </div>
        )}
        ...
        <div className="mt-16 text-center">
          <div className="glass p-8 border border-gold/10 rounded-lg inline-block">
            <p className="text-white font-display text-xl mb-2">
              ¿No sure qué servicio elegir?
            </p>
            <p className="text-muted/60 text-sm mb-4">
              Nuestro equipo te asesorará personalmente
            </p>
            <Link 
              href="/reservar"
