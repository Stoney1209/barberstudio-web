...
import { Scissors, Star, ArrowRight, MapPin, Clock, Phone, Quote } from 'lucide-react'
...
export const LandingContent: React.FC<Props> = ({ initialServices, initialReviews }) => {
  return (
    <div className="min-h-screen bg-black overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl">
          ...
          >
            <p className="text-gold/60 text-xs uppercase tracking-[0.6em] mb-8 font-medium">Desde 2024 • El Arte de la Barbería</p>
          ...
          >
            <p className="text-lg md:text-2xl text-muted/80 max-w-2xl font-light mb-12 tracking-wide leading-relaxed">
              Redefiniendo el estándar del cuidado masculino a través de la 
              <span className="text-gold font-display italic mx-2 text-3xl">maestría</span> 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <motion.div whileHover={{ y: -5 }} className="flex flex-col gap-3 group">
              <p className="text-[10px] text-gold/60 uppercase tracking-widest font-black">Ubicación</p>
              <div className="h-px w-8 bg-gold/20 group-hover:w-12 transition-all" />
              <p className="text-lg font-display text-white italic">Av. Principal 123, Centro Histórico</p>
            </motion.div>
            
            <motion.div whileHover={{ y: -5 }} className="flex flex-col gap-3 group">
              <p className="text-[10px] text-gold/60 uppercase tracking-widest font-black">Horario de Atención</p>
              <div className="h-px w-8 bg-gold/20 group-hover:w-12 transition-all" />
              <p className="text-lg font-display text-white italic">Lunes a Sábado • 09:00 — 20:00</p>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
               ...
               <div className="absolute -bottom-12 -right-12 glass p-12 border border-gold/20 hidden md:block">
                  ...
                  <p className="text-xs text-muted/60 uppercase tracking-widest mt-2">La precisión como dogma</p>
               </div>
            </motion.div>
            ...
            >
               <p className="text-xs text-gold/40 uppercase tracking-[0.4em]">Nuestra Filosofía</p>
               <h2 className="text-6xl md:text-8xl font-display text-white leading-none">
                  Donde la <br />
                  <span className="italic text-gold">tradición</span> se <br />
                  vuelve eterna.
               </h2>
               <div className="h-px w-32 bg-gold/20" />
               <p className="text-lg text-muted/60 font-light leading-relaxed max-w-lg">
                  No somos solo una barbería; somos un santuario para el caballero moderno. 
                  En BarberStudio, cada corte es una declaración de intenciones, 
                  un ritual perfeccionado a través de décadas de técnica europea.
               </p>
      ...
      {/* Featured Services - Horizontal Grid */}
               ...
               >
                 ...
                 <div className="flex justify-between items-end">
                    <div>
                       ...
                       <p className="text-[10px] text-muted/40 uppercase tracking-widest mt-1">Sesión Master</p>
                    </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
              <div className="lg:col-span-4 sticky top-32">
                 ...
                 <p className="text-sm text-muted/40 mt-12 max-w-xs leading-relaxed">
                    Nuestra reputación está construida sobre cada detalle. 
                    Más que testimonios, son crónicas de transformación.
                 </p>
              </div>
                 ...
                 {initialReviews.length > 0 ? initialReviews.map((r, i) => (
                   ...
                   >
                      ...
                      <p className="text-lg text-white/80 font-light italic mb-12 relative leading-relaxed">
                         "{r.comment || 'Una experiencia sin igual. El nivel de detalle es superior a cualquier otra barbería.'}"
                      </p>
